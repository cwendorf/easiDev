...
- Depricated regression and most correlation functions
- Depricated ANOVA and pairwise comparison functions
- Simplified output to use print methods instead of lists
- Removed all "by" functions to focus on analytical strategy
