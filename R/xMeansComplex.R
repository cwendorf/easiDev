...
estimateMeansComplex.default <- estimateMeansComplex.formula <- estimateMeansComplex.wsm <- estimateMeansComplex.bsm <- function(..., contrast1, contrast2, conf.level = .95, labels = NULL) {
...
testMeansComplex.default <- testMeansComplex.formula <- testMeansComplex.wsm <- testMeansComplex.bsm <- function(..., contrast1, contrast2, labels = NULL) {
