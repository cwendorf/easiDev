...
(Outcome~Factor) |> estimateMeans() |> plot()

(Outcome~Factor) |> focus(Level1, Level2) |> estimateMeans()
(Outcome~Factor) |> focus(Level1, Level2) |> estimateMeans() |> plot()
(Outcome~Factor) |> focus(Level1, Level2) |> plotMeans()

(Outcome~Factor) |> estimateMeansSubsets(contrast=c(-1, .5, .5))
...
(OneWaySummary) |> estimateMeans(mu=3)
